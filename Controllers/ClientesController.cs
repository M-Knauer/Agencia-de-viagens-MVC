...
namespace GoodTrip.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_cliente,Nome,Email,CPF,Sexo")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_cliente,Nome,Email,CPF,Sexo")] Cliente cliente)
        {
